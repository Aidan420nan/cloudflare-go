...
// returned.
func (r *ResourceSharingService) Update(ctx context.Context, shareIdentifier string, params ResourceSharingUpdateParams, opts ...option.RequestOption) (res *ResourceSharingUpdateResponse, err error) {
	...
	path := fmt.Sprintf("accounts/%s/shares/%s", params.AccountID, shareIdentifier)
...
// returned.
func (r *ResourceSharingService) Delete(ctx context.Context, shareIdentifier string, body ResourceSharingDeleteParams, opts ...option.RequestOption) (res *ResourceSharingDeleteResponse, err error) {
	...
	path := fmt.Sprintf("accounts/%s/shares/%s", body.AccountID, shareIdentifier)
...
// Fetches share by ID.
func (r *ResourceSharingService) Get(ctx context.Context, shareIdentifier string, query ResourceSharingGetParams, opts ...option.RequestOption) (res *ResourceSharingGetResponse, err error) {
	...
	path := fmt.Sprintf("accounts/%s/shares/%s", query.AccountID, shareIdentifier)
...
func (r ResourceSharingNewParamsResourcesResourceType) IsKnown() bool {
	switch r {
	case ResourceSharingNewParamsResourcesResourceTypeCustomRuleset:
		return true
	}
	return false
}
